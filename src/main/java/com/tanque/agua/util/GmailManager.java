...
public class GmailManager {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/credenciales/credentials.json";
     ...
     */
    public Gmail getInstance() throws GeneralSecurityException, IOException {
